...
\msnote{I'm indeed leaning towards the introduction of (something like)
Overlay. The rationale is that we current have DCI(a set of resource(physical
quantity)) but no term to refer to the set of resources provisioned through
pilots. I also need some term to describe the property related to pilot
provisioning.}
