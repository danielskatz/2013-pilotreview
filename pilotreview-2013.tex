...
\jhanote{We need 1-2 paragraphs describing the relationship of this paper to P*
  ...
  the reader. Where this paragraph goes is open for discussion, but please draft
  a paragraph.}
...
\jhanote{This paragraph is possibly a nice way to start rather than end this
  sub-section. Thoughts?} The generality of the \pilot paradigm may come as a
surprise when considering the requirement that has motivated most
