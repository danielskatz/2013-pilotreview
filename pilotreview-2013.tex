...
well-defined core terminology to reasoning about such systems. 

In this section, a set of relevant \pilotjob implementations critically
reviewed. The goal is twofold: showing how, within the boundaries set by the
minimal description offered in \S\ref{sec:vocab}, each \pilotjob system
provides specific sets of features; and uncovering how capabilities are
differently clustered across pilotjob systems. Thanks to this analysis,
indications will be given about choosing a pilot system based on functional
requirements, how a pilot system should be designed and engineered, and what
are the theoretical properties that underling such systems.
