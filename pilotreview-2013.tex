...
\jhanote{just a reminder that Glidein might not be service but just jobs, as
  discussed at:
  http://www.uscms.org/SoftwareComputing/Grid/WMS/glideinWMS/doc.prd/index.html}D
...
glidein), communicates the match to the Schedd that submits the tasks to the
indicated Startd daemon.

The execution model of GlideinWMS...
