...
(ii) advanced \pilotjob systems offer sophisticated resource management
capabilities based on \pilots and (iii) higher level \pilot-based frameworks
utilize \pilots for a specific use case, e.\,g.\ workflows or data analytics.
...
In this section, we give a brief overview of different \pilotjob systems. After a 
discussion of pre-pilot systems in section~\ref{sec:prepilot}, we will in-depth 
discuss the three types of \pilotjob systems in sections~\ref{sec:corepj} -- 
...
The main design goal of AppLeS is to enable users
to submit jobs to multiple computing resources via a
single unified interface, granting the
appearance of a ``personal cluster''.
The ``personal cluster'' concept requires several further
