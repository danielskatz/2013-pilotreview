...
\jhanote{in addition to tps the total number of tasks executed is also
  an important consideration sometimes}
...
\jhanote{this paragraph needs major rewriting. unclear what the
  message/aim is} Some simulations require varying number of tasks to
complete -- that is, 10 tasks may start a program but the results of
these tasks may spawn more tasks to complete. \pilotjobs can be
...
\begin{table*}[t]
 ...
 \begin{tabular}{|p{3cm}|p{3.2cm}|p{3cm}|p{3cm}|p{3cm}|}
  ...
  \hline
          AppLeS            & --                                       & --                                 & --                     & --                     \\ 
  \hline
          MyCluster         & Manual, Explicitly User-controllable     & Manual                             & --                     & --                     \\ 
  \hline
...
%
\subsubsection{PanDA}
\aznote{Some of this is limited to the PanDA Pilot Factory paper -- 
unsure as to where we should draw the line over what is included as part
of PanDA ``proper'', and what is part of extensions...}
