...
accounting (AAA), elaborate data staging, tailored load-balancing and
...
staging is required only by specific type of workloads while fault-
...
capabilities offered by specific DCI. Nonetheless, \pilotjob systems can
be devised in which tasks do not require data management because they
(i) do not necessitate input files, (ii) do not produce output files,
(iii) data is already locally available or (iv) data management is left
to the application itself. As such, data management should not be
considered a necessary functionality of a \pilotjob system even if, in
practice, it is present in most of its implementations.
