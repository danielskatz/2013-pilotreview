...
\subsubsection{BoSCO - Light(er)-Weight User-Level Condor}
...
(the system that runs the job manager service, this 
can often be the user's laptop). similar to schedd



- supports fault tolerance (re-submission)
- throttling 
