...
This work suggests that there is enough commonality across \pilot
implementations and functionality that a set of \pilot ``building blocks'' that
help find the balance between specific and general should be possible.  Thus it
is possible to have well-defined models of \pilot functionality, as well as an
...
would help address the aforementioned cardinality issue.  Furthermore the
critical commonality amongst \pilot systems is arguably unique amongst other
tools and middleware, which thus allows \pilot systems to serve as an
interesting case-study in to the underlying reasons for the proliferation of
functionally similar but otherwise distinct software systems.  A future analysis
of software decisions and development trajectory of the \pilot implementations
could also provide insight into how sustainable software ecosystems might
evolve.
