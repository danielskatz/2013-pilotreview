...
\begin{itemize}
  ...
  \item \textit{Supported DCI systems/services}: What are the type of systems (middelwares, services) 
...
\begin{itemize}
  ...
  \item \textit{Task-pilot relationship (spatial)}: Does a pilot execute one ore more tasks concurrently? 
