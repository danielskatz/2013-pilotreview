...
\jhanote{There is no reference to figure 2 and 3, both literally as
  well as in the flow of text. for example, currently we develop
  place-holder job before coordination (if at all), but figure 2 seems
  to imply the reverse -- either chronoligically or in terms of
