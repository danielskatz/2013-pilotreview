...
BigJob (being a prototype), recently re-implemented as a production-level
system named ``RADICAL-Pilot'' [ref], represents one of the latest evolutionary
stages of the \pilot abstraction. From an initial phase in which \pilot were
implemented as ad hoc place holder machinery for a specific application, to the
integration of \pilot systems within the middleware of remote resources,
RADICAL Pilot implements the \pilot abstraction as an interoperable compute and
...
probably not what we want to say ...}
