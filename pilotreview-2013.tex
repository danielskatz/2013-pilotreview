...
grid/batch systems to allow job submission to clouds and grid infrastr. CoPilot uses XMPP messaging to communicate between
...
available to the pool. In contrast to Condor-G/Glide-In, the \pilot
capabilities are not directly exposed to the end-user. GlideinWMS is currently
deployed in production on OSG and is the recommended mode for accessing OSG
resources.
