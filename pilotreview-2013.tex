...
abstractions are offered. \jhanote{``bind to'' compute resources in the first
  ...
  fine. consistent with placeholder too.} \mtnote{Done.}
...
adapted.  The goal of of this sub-section \mtnote{Check consistency between
sub-section and subsection} is not only to underline the differences among
\pilot systems, but to show the challenges in implementing them and to highlight
the evolution that \pilot system implementations are undergoing. \jhanote{this
is an interesting/important point. Are pilot systems evolving or are they
adapting to the evolution of technology/infrastructure etc?} \mtnote{Probably
both?}
