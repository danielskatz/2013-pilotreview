...
\item \textbf{Pilot Characteristics}: As resource placeholders, pilots
  have different characteristics depending on the type and
  capabilities of the resources they expose and of the infrastructure
  on which they are provisioned. \jhanote{Opening clause, needs
    revision. Sorry I can't proffer something, as I'm not sure of the
    intent} Within the domain of each type of resource, some of the
  typical characteristics of pilots are: Size (e.g. number of cores),
  lifespan, intercommunication (e.g.  low-latency or inter-domain),
  computing platforms (e.g. x86, Cray, or CUDA), file systems
  (e.g. local, shared, or distributed). \jhanote{I'm a bit confused
    between resource and infrastructure semantics now. See general
    remark at the end of core properties. Does that help refine this
    paragraph?}
...
\item \textbf{Task Binding Characteristics}: As seen in
...
\item \textbf{Security}: While the properties of \pilotjob implementations 
