...
systems.\alnote{the previous characteristics are not defined yet. Are they
suppose to get defined in 2?} Other aspects as interfaces, packaging,
...
assign a name to these two components?}
...
makes these systems advanced.} The same is valid for Corral or SWIFT. They
...
execution belongs to two distinct components. \alnote{Without getting into some more analysis for Corral and Swift, the value by stating that they have a workload manager and task executor is limited.}
...
and task dispatching. \alnote{is data staging minimal?} The procedures to 
