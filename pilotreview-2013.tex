...
\begin{abstract}
  ...
  computing, for example, \pilotjobs systems are used to provide more than 700
...
and usages. This hinders attempts at distinguishing \pilotjob system
functionalities from those of other middleware and an appreciation of the
...
machine. The third box represents the pilot once that it has been instantiated
on the DCR, and the fourth box represent the resources held by the pilot.
...
Task Manager to executes those tasks once the pilot has become available
...
developed and maintained by the Distributed Systems Laboratory at University of
Chicago. The primary goal of the Coaster System is to provide \pilot abstraction
...
implements a dedicated communication protocols used both for coordination and
...
Thanks to the generality of the \pilot paradigm with respect of types of
workload, target DCR, and resource, \pilot systems offers a well-defined and
...
batch system, or any other special-purpose software component. \pilot systems
represents a software system in itself.
