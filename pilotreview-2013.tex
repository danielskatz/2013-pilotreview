...
makes no distinction among alternative supercomputer architectures.} but also of
the coordination pattern for distributed and parallel computation called
``\MW''.
...
duration of the submitted job, resource availability, and fair usage policies.
...
device with a lot of computational capacity. I added a footnote, any better?}
