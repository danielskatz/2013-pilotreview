...
\mtnote{Different pool implementations, ways to make tasks available to
the manager: potential topics to discuss in Section 4?}
...
\mtnote{Capabilities across different manager implementations: potential
topic to discuss in Section 4?}
...
\mtnote{Binding capabilities; execution model; late-binding
capabilities: potential topics to discuss in Section 4?}
