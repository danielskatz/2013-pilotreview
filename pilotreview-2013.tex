...
chronological order. \jhanote{merge the previous sentence with the
  paragraph beginning with The \pilotjob systems are said to implement multi-level scheduling because..}
...
implementations. Two sets of properties are introduced: Core
...
auxiliary properties are not unique to \pilotjob and are properties
