...
Nimrod/G~\cite{10.1109/HPC.2000.846563}, Falkon~\cite{raicu2007} and
MyCluster~\cite{1652061,mycluster-clade,walker2007personal} to name a few. These
...
% runtime~\cite{1742-6596-219-6-062049,frey2002condorG,nilsson2011atlas}.
...
one administrative domain but Flocking~\cite{Epema:1996:flocking} made it
...
within the HTCondor system. HT\-Con\-dor-G/Gli\-de\-In~\cite{frey2002condorG} allowed
users to add remote grid resources to resource pools. In this way, users could
uniformly execute jobs on resource pools composed by diverse resources. Thanks
to its use of resource placeholders, GlideIn was one of the systems pioneering
the \pilot abstraction implementation, enabling some \pilot capabilities also
for third parties systems like Bosco~\cite{bosco}.
...
the data. AliEn deploys a pull-based model~\cite{saiz2003alien} assuming that
...
Open APIs like the one specified in~\cite{pstar-2012} and implemented by
