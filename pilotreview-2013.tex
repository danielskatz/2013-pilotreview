...
\mtnote{Here we can add the description of workloads across the three axes. This would support the workload semantic core property in \S4.}
...
% \begin{tabular}{|p{2cm}||p{2cm}|p{2cm}|p{2cm}|p{2cm}|p{2cm}|p{2cm}|}
  \begin{tabular}{p{3cm}p{3cm}p{2.25cm}p{2.25cm}p{2.25cm}p{2cm}p{2cm}|}
...
workflows - we did that already twice.} The current state of the workflow
...
interoperability and curtailing the need to create unsustainable partial
implementations.
