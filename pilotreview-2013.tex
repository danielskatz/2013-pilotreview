...
\jhanote{Please check my edit/deletion. I did not think the statement and
  ...
  that data are not a necessary functionality of \pilot systems. If we think
...
an administrative domain\}. \mtnote{I used `set of machines' because from now on we use DCR instead of machine and, as such, I think we need to link explicitly the two. Would you agree?}
