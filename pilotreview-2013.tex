...
\jhanote{forward reference, a matter of style, but either way must be
  conservative with its usage} \jhanote{The 5th and 6th paragraphs
  should be moved. It is interrupting the flow and delaying the reader
  from getting to the message. 5th and 6th are useful but we should
  present caveats/enhancements/refinements to a message only after we
  have finished delivering the main message. For example, we can move
  the discussion of C\&C to where we talk about data management.}
...
and coordination.  \jhanote{suggestion: we should replace architecture
...
DCI's resource. \mrnote{This paragraph is making it somewhat difficult
...
and executed. \jhanote{need to justify the above sentence.}\mrnote{Maybe
...
workloads. \mrnote{Might not need the descriptive clause. We've covered
...
be used also to indicate a DCI. \jhanote{I think this entry should be
...
provisioned.  \mrnote{I'm uncomfortable with the word programs again,
