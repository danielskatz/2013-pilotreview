...
this stage it would be fair to say that a pilot can be active or inactive}. Early binding
...
that pilot\msnote{I might start to understand where you want to go with this,
but I'm not sure if this holds in a HTC scenario where you have many pilots.
By then "early" binding tasks to pilots, you actually loose flexibility}
. Late binding is critical in assuring high throughput by allowing
...
schedulers and in distinct chronological order. \msnote{Do we mean "by"
...
described.\msnote{I dont fully understand what is written here, probably a good
discussion point for the meeting}
