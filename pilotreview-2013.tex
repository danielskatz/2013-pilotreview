...
\jhanote{consistency between PJ sytems and \pilot systems and
  \pilotjob systems please}
...
\begin{table*}[t]
 ...
 \begin{tabular}{|p{3cm}|p{3.2cm}|p{3cm}|p{3cm}|p{3cm}|}
  \hline
  \textbf{Pilot-Job System} &\textbf{Pilot (Agent) Provisioning}       &\textbf{Job-to-Resource Binding}    &\textbf{Single-/Multi-User Pilots} &\textbf{Classifier IV}  \\
  \hline
          AppLeS            & --                                       & --                                 & --                     & --                     \\ 
  \hline
