...
DCIs. \mrnote{Im not sure entirely if we are speaking of a distributed
computing infrastructure or a single machine here.} 
...
would mean submitting to a grid-wide scheduler, not a specific 
machine-specific scheduler}
