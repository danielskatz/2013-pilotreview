...
to distributed resources in a uniform manner.  \aznote{Not required for
...
was created with the primary objective
...
in a grid environment, but has since been expanded to a 
variety of current cyberinstractures - including clouds.

Falkon has been 
shown to run on TeraGrid (now XSEDE), TeraPort, Amazon EC2, IBM
Blue Gene/L, SiCortex, and Workspace Service.
...
\mrnote{Cite: \url{http://dev.globus.org/wiki/Incubator/Falkon/DataDiffusion}}
...
capabilities with its Provisioner. The Falkon Provisioner
is the creator and destroyer of Executors, and is capable of 
...
with the Karajan workflow execution engine\mrnote{cite}. This
