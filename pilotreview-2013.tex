...
%
%Application: a BigJob script that can also involve logic
%and algorithms external to PJ system communication
%Workload: A set of CUs
%Task: CU
%Resource: What is asked for in PCD
%Infrastructure: Where BJ runs (grids, clouds, clusters)
%
%
%
%The core properties of BigJob are as follows:
%
%Pilot Characteristics can be user-defined using a
%Pilot Compute Description. Define what that is.
%Pilot characteristics
%are often limited by policies on the infrastructures
...
%
%Resource dependencies: Not sure what this is. Here is an attempt.
%BigJob can bootstrap itself into user-space on external targeted 
%infrastructures, provided that the python version is greater than 2.5.
%
%C\&C: Redis
%
%Workload semantics: User-defined location affinity, wherein labels
...
%
%Binding Characteristics: Late-binding only. Ask someone if this is true.
%
%Deployment strategies: Allows for user to define env variables and input arguments.
