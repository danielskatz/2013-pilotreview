...
become available only once the job has become active, and is available only for
...
possibly increasing the throughput of the workload execution. Moreover, pilots
can be reused to execute multiple workloads until the pilots are no longer
active.  How tasks are actually assigned to pilots is a matter of
implementation. For example, a dedicated scheduler could be adopted, or tasks
might be directly assigned to a pilot by the user.
