...
\begin{abstract} 
  ...
  system-provided scheduler. Nearly everything else is either specific
...
\aznote{Considering the new direction of the paper, I am not sure whether GW}
GWPilot \cite{gwpilot}.
...
the inclusion of Bosco in this section as Bosco appears
