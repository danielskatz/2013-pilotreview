...
aspects of early binding can also be achieved without a \pilot, but,
importantly, the \pilot paradigm allows to do both, even within the
confinements of a single workload. \msnote{I would think parts of this
paragraph also have their place in S5 (if its not already there)} \mtnote{The
notion of binding needs to be fully understood before getting into 4. I would
leave this as it is here but I am open to discuss about it.}
...
paragraph altogether.} \mtnote{I am not sure I see why it is orthogonal.}
...
\begin{table*}
 ...
 \caption{\textbf{Mapping of the core terminology of \pilot systems into the
     ...
     caption.}\mtnote{Done in the text.}}
