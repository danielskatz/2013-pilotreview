...
BigJob offers an application-level programmability to give to the end-user more
flexibility and control over the design of distributed application and the
isolation of the management of their execution. BigJob is flexible and
extensible and works on a variety of infrastructures through the use of the
Simple API for Grid Applications (SAGA) interoperability library [ref].
...
represents one of the latest evolutionary stages of the \pilot abstraction.
From an initial phase in which \pilot were implemented as ad hoc machinary for
a specific application, to the use of \pilot systems within the remote
resources, PilotJob implements the \pilot abstraction as an interoperable
compute and data management system that can be programmatically integrated into
end-user applications.

Another ongoing evolutionary trend of the \pilot abstraction is to move away
from providing simple \pilot capabilities in application space, towards
\pilot-based workload managers. These higher-level systems which are often
