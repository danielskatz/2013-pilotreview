...
A variety of \pilotjob systems have emerged: Condor-G/ Glide-in~\cite{frey2002condorG},
...
\mtnote{Possibly add a paragraph summarizing the salient evolutionary steps of
  \pilot systems as described in Subsection 2.2.}\cite{frey2002condorG}
...
within the Condor system. Condor-G/GlideIn~\cite{frey2002condorG} allowed users to add
...
AliEn~\cite{1742-6596-119-6-062012} and Co-Pilot~\cite{buncicco}. Each of
