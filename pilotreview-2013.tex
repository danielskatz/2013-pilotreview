...
\jhanote{if we are calling this ``evolution'' we should be sure to
  ...
  even create a table of timelines. thanks}\mrnote{We stopped
  calling it an evolution}
...
provisioned. DCIs offer compute, data\msnote{Im tempted to say storage} and
network resources and \pilotjobs allow for the users to utilize those resources
to execute the tasks of a workload.
