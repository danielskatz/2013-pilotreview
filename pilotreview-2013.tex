...
characterize each and every component of a \pilotjob implementation. As such,
auxiliary properties are considered global properties of a system without
defining any of its distinguishing feature.\mtnote{I am rambling here, maybe
...
vastly varies across implementations. Some \pilotjob systems support workflows-
based applications, others jobs that leverage a Message Passing Interface
(MPI). Analogously, every \pilotjob systems support the execution of one or
more type of workload but they differ when considering execution strategies
that maximize throughput (HTC), computing (HPC) or container-based, high
scalability (Cloud). 
