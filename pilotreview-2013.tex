...
\begin{table*}[t]
 ...
 \begin{tabular}{|p{3cm}|p{3cm}|p{3cm}|p{3cm}|p{3cm}|}
  \hline
  \textbf{Pilot-Job System} &\textbf{Classifier I} &\textbf{Classifier II} &\textbf{Classifier III} &\textbf{Classifier IV}  \\
  \hline
          AppLeS            & --                   & --                    & --                     & --                     \\ 
  \hline
          MyCluster         & --                   & --                    & --                     & --                     \\ 
...
\onote{TO DISCUSS: Shouldn't we rahter talk about Condor itself? The WMS aspect of 
glideinWMS is automatic pilot submission via factories and is not a 
'core' Pilot Job functionlaity. }
...
now handled entirely by the GlideinWMS factory.
...
CorralWMS pilots (glideins) are bound to one specific user via personal 
X.509 certificates. This enables resource provisioning in non-VO centric 
environment, which includes many of the HPC clusters that are part of U.S.
