...
\mrnote{citeFalkonPaper} was created with the primary objective
...
a remote environment\mrnote{cite Falkon paper}.
...
to GRAM and GRAM/Clustering methods\mrnote{citeFalkonPaper}.

\paragraph{Deployment Scenarios}

The Swift parallel programming system\mrnote{citeSwift} was integrated
...
with the Karajan workflow execution engine\mrnote{citeKarajan}. This
