...
\begin{abstract}
  ...
  incarnation of which are the many \pilotjob software systems.  \pilotjob
  systems have played an important role in supporting distributed scientific
  computing, for example, \pilotjob systems are used to provide more than 700
  million CPU hours a year to the Open Science Grid communities in the search
  for the Higgs Boson, and to process up to 5 million jobs a week for the ATLAS
  experiment. With the increasing importance of task-level parallelism in
  high-performance computing, \pilotjob systems are witnessing an adoption
  beyond traditional domains. Notwithstanding their growing impact on scientific
  research, there is no agreement upon their definition and no clear
  understanding of the underlying abstraction and paradigm. This lack of
  foundational understanding and of design convergence has lead to a
  proliferation of unsustainable implementations with no shared best practices
  or interoperability among their implementations, and ultimately hindering a
  realization of the full impact of the \pilotjobs.  This paper offers the
  conceptual tools to promote shared understanding of the \pilot paradigm while
  critically reviewing the state of the art of \pilotjob implementations. Five
  ...
  auxiliary properties of \pilotjob systems; and (v) a critical review of the
...
dependences. Now, \panda also supports applications from a variety of science
domains.\cite{x,y}.
