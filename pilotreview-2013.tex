...
As non-functional properties we define the properties that are not
specifically related to \pilotjob systems but rather describe general concepts
commonly found in distributed applications, frameworks and tools. These
properties are:
