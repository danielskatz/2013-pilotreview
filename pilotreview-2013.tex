...
\jhanote{I think all the functionality of PJs is predicated on the
  ...
  functionality?} \mtnote{The previous paragraph is a first attempt to
  address this comment. More details will follow when late binding
...
\texttt{``Distributed processing and analysis of ATLAS
experimental data'' 2011 paper} says 100k+, atlas panda pilot in operation
paper says 40-50k}, which handle
simulation, analysis, and other work.  Cloud capabilities have been used as part
of Helix Nebula \texttt{presentation, cite?} (CloudSigma, T-Systems, ATOS) as well
as in FutureGrid and the Synnefo cloud, extending the reach of PaNDA to
