...
\jhanote{sorry my remark wasn't very clear: i meant we need citations rather
  than a simple reference to grid and or cloud computing. Either upstream or
  with ``all these..."}\mtnote{Done.}
...
\jhanote{maybe same case here. specific examples/citations as
  opposed to ``grid computing''} \mtnote{Not sure I managed to found appropriate
  references.}
...
\jhanote{first sentence needs attention} \mtnote{Better?}
