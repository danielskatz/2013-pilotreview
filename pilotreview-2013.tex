...
The manager for DIANE is called the \texttt{Master}, and contains
the scheduler for DIANE, which is known as the \texttt{Planner}.
...
are aggregated through use means of the DIANE \texttt{Integrator}.
