...
architectural, provision and execution characteristics of \pilotjob systems.
...
aspects that directly depend on the characteristics and capabilities taken here
into consideration.
...
\jhanote{I'm not sure I agree with the very last bit of
  ...
  Fine by me but the issues would remain: why only the functional one?}\\---\\
...
\mrnote{"are necessary" - "have to" sounds awkward in this context} 
...
\alnote{maybe cleanly separating architecture and the way the workload
  ...
  make that separation. Care to elaborate, suggest an editing?}\\---\\
...
PJ system we currently know of uses data staging}\\---\\
