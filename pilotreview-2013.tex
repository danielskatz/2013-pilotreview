...
\jhanote{MR suggests ``and associated logic'' along with ``possibly correlated''}
...
\mrnote{(i) My issue here is, a single workload is a set of tasks. An
  ...
  define an application.  (ii) On the note of consumers, I find the
  use of the phrase 'pilot job consumer', when not previously
  discussed or defined in this manner, unclear. At this point, you
  haven't defined what it means to be a Pilot Job system consumer. It
  is unclear in what way an Application 'consumes' PJ resources (by
  definition, not by my knowledge)}
