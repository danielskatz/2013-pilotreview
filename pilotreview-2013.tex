...
functionality. Workload Execution identifies the types of tasks and the
mechanisms for their executions. As such, this property characterizes the
...
Workload Execution &
Types of tasks and the mechanisms for their execution &
Task Manager &
Task Execution \\
...
\item \textbf{Pilot Deployment}. Modalities for pilot scheduling, bootstrapping,
  ...
  order to gather and leverage information about type of container (job, virtual
...
\item \textbf{Workload Semantics}. The tasks of a workload are dispatched to
  ...
  degrees of semantic richness of workloads and its tasks. \mtnote{add
  examples? See note in \S3 about having a general description of workloads across the three axes, possibly with an example of taxonomy to use here and in the table of core properties.}
...
\item \textbf{Task Binding}. The Task Dispatching functionality implies the
  ...
  scheduling. \mtnote{To be reduced and cleaned up.}
