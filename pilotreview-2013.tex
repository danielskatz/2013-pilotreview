...
functional requirements, how \pilotjos systems are designed and engineered, and
...
implementations. Two sets of properties are introduced: Fundamental and
auxiliary. \textit{Fundamental} properties are common to each \pilotjob
implementation and, as such, directly derived from the minimal description
offered in Section 3. Auxiliaries properties characterize instead specific
\pilotjob implementations and they are not shared among all implementations.
