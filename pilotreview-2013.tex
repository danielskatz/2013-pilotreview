...
Multi-level scheduling is achieved by scheduling the placeholder and then by
enabling direct scheduling of application tasks to that placeholder.
% Mul\-ti-\-le\-vel sche\-du\-ling is achieved by scheduling the agent and then
% by enabling direct scheduling of application tasks to that agent.
The \MW pattern
is often an effective choice to manage the coordination of tasks execution on
the available agent(s).
Mul\-ti-\-le\-vel sche\-du\-ling can be extended to
