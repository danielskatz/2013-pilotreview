...
This Section offers an analysis of the architectural components, functionalities, and terminology shared by every \pilotjob system. The goal is to offer both a conceptual description of an exemplar \pilotjon system and a well-defined vocabulary that can be leveraged to produce a comparative and critical analysis of diverse \pilotjobs frameworks in \S\ref{sec:4} and \S\ref{sec:5}.
...
classifiers along which we discuss the functional and non-functional aspects of
\pilotjob systems.  While these classifiers are by no means exhaustive or
complete, they are a useful tool to highlight and discuss the differences in 
usage-modes, deployment and capabilities between different \pilotjob systems.

\subsubsection{Resource Provisioning}

\subsubsection{Workload Execution and Management}

\subsubsection{Data Handling and Management}
