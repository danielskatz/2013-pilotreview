...
Executor should not be used as defining features of \pilot systems. Such
a distribution depends on the communication and coordination patterns
...
including only those capabilities related to task submission and a
feautre-rich Task Executor capable or coordinating with its neighboor
